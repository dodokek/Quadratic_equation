...
extern const double Accuracy = 0.000001;

extern const int SolveSqrOpt = 1;

extern const double POISON_NUM = 12345.6;

extern const int MAX_DATA_SIZE = 100;

extern const double INF = 1000000000;
